...
# discretized <- discretize(carseats[,c(2,3,6,7,9)],
#                           method = "quantile",
#                           breaks = c(5,2,5,2,5)) 
...
# izmenimo redosled, da nam izlazna varijabla bude na kraju
...
# to nam je nb2.coords[23,4] i mozemo to da koristimo prema slici
